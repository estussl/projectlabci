...
<body id="page-top">
    ...
    <nav id="mainNav" class="navbar navbar-fixed-top">
        <div class="container">
            <a class="navbar-brand page-scroll" href="#page-top">Sekolah Startup</a>
            ...
            <div class="collapse navbar-toggleable-sm" id="navbarResponsive">
                <ul class="nav navbar-nav float-md-right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="<?php echo base_url();?>Login">Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <a href="<?php echo base_url();?>Daftar_Siswa" class="page-scroll btn btn-xl">Sing Up Now!</a>
            </div>
        </div>
    </header>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url();?>assets_pub/img/portfolio/roundicons.png" class="img-fluid" alt="">
                    </a>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url();?>assets_pub/img/portfolio/startup-framework.png" class="img-fluid" alt="">
                    </a>
                    <div class="portfolio-caption">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url();?>assets_pub/img/portfolio/treehouse.png" class="img-fluid" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Treehouse</h4>
                        <p class="text-muted">Website Design</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url();?>assets_pub/img/portfolio/golden.png" class="img-fluid" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Golden</h4>
                        <p class="text-muted">Website Design</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url();?>assets_pub/img/portfolio/escape.png" class="img-fluid" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Escape</h4>
                        <p class="text-muted">Website Design</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?php echo base_url();?>assets_pub/img/portfolio/dreams.png" class="img-fluid" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Dreams</h4>
                        <p class="text-muted">Website Design</p>
                    ...
                    <ul class="timeline">
                        <li>
                            <div class="timeline-image">
                                <img class="rounded-circle img-fluid" src="<?php echo base_url();?>assets_pub/img/about/1.jpg" alt="">
                            </div>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="rounded-circle img-fluid" src="<?php echo base_url();?>assets_pub/img/about/2.jpg" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>March 2011</h4>
                        ...
                        <li>
                            <div class="timeline-image">
                                <img class="rounded-circle img-fluid" src="<?php echo base_url();?>assets_pub/img/about/3.jpg" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>December 2012</h4>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="rounded-circle img-fluid" src="<?php echo base_url();?>assets_pub/img/about/4.jpg" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>July 2014</h4>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="<?php echo base_url();?>assets_pub/img/team/1.jpg" class="img-fluid rounded-circle" alt="">
                        <h4>Estu Susilo</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="<?php echo base_url();?>assets_pub/img/team/2.jpg" class="img-fluid rounded-circle" alt="">
                        <h4>Arradzkru Alfath</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="<?php echo base_url();?>assets_pub/img/team/3.jpg" class="img-fluid rounded-circle" alt="">
                        <h4>Miracle T. Rumondor</h4>
