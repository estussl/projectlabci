                ...
                <ul class="nav navbar-nav float-md-right">
                    ...
                    <?php
                     if(!isset($username))
                     {
                        ...
                        echo "<a class='nav-link page-scroll' href=" .  base_url() . "#services><font color='#808080'>Services</font></a>";

                        echo "<li class='nav-item'>";
                        echo "<a class='nav-link page-scroll' href=" .  base_url() . "#portfolio><font color='#808080'>Portfolio</font></a>";

                        echo "<li class='nav-item'>";
                        echo "<a class='nav-link page-scroll' href=" .  base_url() . "#about><font color='#808080'>About</font></a>";

                        echo "<li class='nav-item'>";
                        echo "<a class='nav-link page-scroll' href=" .  base_url() . "#team><font color='#808080'>Team</font></a>";
                     ...
                     if(isset($username))
                     {
                        ...
                        {
                           echo "<li class='nav-item'>";
                           echo "<a class='nav-link page-scroll' href=" .  base_url() . "Siswa/lihat_nilai><font color='#808080'>Nilai</font></a>";
                        ...
                        else if($jenis_user == 2)
                        {
                           ...
                           echo "<li class='nav-item'>";
                           echo "<a class='nav-link page-scroll' href=" .  base_url() . "Guru/gurupost><font color='#808080'>Kelola Nilai</font></a>";
                           // echo "<li>";
                           // echo anchor(base_url() . 'Guru', 'Kelola Nilai');
                        }
                        echo "<li class='nav-item'>";
                           echo "<a class='nav-link page-scroll' href=" .  base_url() . "Login/keluar><font color='#808080'>Logout</font></a>";
                    }
                    else{
                        echo "<li class='nav-item'>";
                           echo "<a class='nav-link page-scroll' href=" .  base_url() . "Login><font color='#808080'>Login</font></a>";
                    }
